...
\begin{itemize}[itemsep=3pt]
    ...
    \item \textbf{8 CLI commands} — full workflow via terminal
\end{itemize}
...
You should see a list of 8 available commands: \texttt{export}, \texttt{grade}, \texttt{list}, \texttt{login}, \texttt{models}, \texttt{parse-pdf}, \texttt{review}, \texttt{upload}.
